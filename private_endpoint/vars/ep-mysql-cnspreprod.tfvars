...
private_endpoint_name           = "ep-mysql-cnspreprod"
...
private_service_connection_name = "ep-mysql-cnspreprod"
vlink_tags                      = { "ENV" = "PROD" }
...
sub_resource_id                 = "/subscriptions/5c7ffb4d-2288-4bc0-a920-78bab3f2db58/resourceGroups/rg-cnspreprod/providers/Microsoft.DBforMySQL/servers/mysql-cnspreprod"
sub_resource_names              = ["mysqlServer"]
azure_private_dns_zone_name     = "privatelink.mysql.database.azure.com"
custom_network_interface_name   = "ep-mysql-cnspreprod-nic"
#pdz_counter                     = 0
#vlink_counter                   = 0
tags = {
