...
resource_group                 = "rg-cargoescustoms-svc-prod"
virtual_network                = "vnet-cargoescustoms-svc-prod"
virtual_network_resource_group = "rg-cargoescustoms-svc-infra-prod"
subnet                         = "snet-aksnode-cargoescustoms-svc-prd"
pod_subnet_enabled             = true
pod_subnet                     = "snet-akspod-cargoescustoms-svc-prd"
cluster_name                   = "aks-ccssvc-prod"
