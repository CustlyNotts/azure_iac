...
name                = "vnet-appgw-dpworldcms-nonprod"
use_ipam            = true
vnet_mask           = 27
subnets = [
  {
    name      = "snet-appgw-dpworldcms-nonprod"
    snet_mask = 28
  }
]
...
peerings = {
  peer-vnet-appgw-to-vnet-dpworldcms-nonprod = {
    remote_virtual_network_id = "/subscriptions/e0a9a8f4-21e9-4860-970c-042dd12d6539/resourceGroups/rg-dpworldcms-nonprod-infra/providers/Microsoft.Network/virtualNetworks/vnet-dpworldcms-nonprod"
  }
}
