...
os_disk = {
  ...
  create               = "FromImage"
  name                 = "vm-ecommercedm-preprod_OsDisk_1_c33036624d6845c284802b1f43add94f"
  disk_size_gb         = "127"
  type                 = "Premium_LRS"
}
...
new_network_interface = {
  name                = "vm-ecommercedm-pr393"
  resource_group_name = "rg-ecommercedragonmart-preprod"
  ip_configurations = [
    {
      name                          = "ipconfig1"
      private_ip_address_allocation = "Dynamic"
      private_ip_address            = "10.165.86.7"
    }
  ]
}
