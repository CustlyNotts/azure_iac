...
os_disk = {
  ...
  create               = "Attach"
  name                 = "Vmrostimaprod-2_OsDisk_1_3625d55d32654159bffb56f69a13d2ac"
  disk_size_gb         = "127"
  type                 = "Premium_LRS"
}
...
new_network_interface = {
  name                = "vmrostimaprod-2904"
  resource_group_name = "Rg-Rostima-Prod"
  ip_configurations = [
    {
      name                          = "ipconfig1"
      private_ip_address_allocation = "Dynamic"
      private_ip_address            = "10.154.4.8"
    }
  ]
}
...
tags = {
  ...
  "ENV" : "PROD",
  "Last Backup" : "02/01/2024, 05:17:22 PM"
}
