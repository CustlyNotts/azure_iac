...
os_disk = {
  ...
  create               = "FromImage"
  name                 = "vm-privatelocation-prod_OsDisk_1_2c31b05bf7484d2793674d7d6635d82b"
  disk_size_gb         = "64"
...
os_profile = {
  computer_name  = "vm-privatelocation-prod"
