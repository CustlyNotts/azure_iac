...
os_disk = {
  ...
  create               = "FromImage"
  name                 = "vm-ecommercedb-nonprod_OsDisk_1_ec7788a953354eceb76537066881c01d"
  disk_size_gb         = "128"
  type                 = "Premium_LRS"
}
...
new_network_interface = {
  name                = "vm-ecommercedb-no375"
  resource_group_name = "rg-ecommerce-dev"
  ip_configurations = [
    {
      name                          = "ipconfig1"
      private_ip_address_allocation = "Dynamic"
      private_ip_address            = "10.165.84.29"
    }
  ]
}
